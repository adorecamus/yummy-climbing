			...
			<div class="shadow p-5 bg-white" style="border-radius:20px;">
				<div class="contact-form">
					...
					<div class="form-group mb-4 pb-2">
						...
						<input type="text" class="form-control shadow-none" id="uiPwdCheck" placeholder="닉네임">
					</div>
				</div>
			</div>		
			<div class="shadow p-5 bg-white" style="border-radius:20px;">
				<div class="contact-form">
					<div class="form-group mb-4 pb-2">
						...
						<input type="text" class="form-control shadow-none" id="uiPwdCheck" placeholder="이름">
					</div>
					<div class="form-group mb-4 pb-2" style="width:45%">
						<div>
						<label class="row form-label">AGE</label>
						<input type="text" class="form-control shadow-none" id="uiPwdCheck" placeholder="나이"></div>
					...
					<div class="row addrBtn">
						<button class="btn btn-outline-primary" style="width:45%; margin:0 13px 0 10px;" onclick="searchAddr()">주소검색</button>
					</div>
					<div class="form-group mb-4 pb-2">
						<select id="uiGender" class="form-select">
							<option value="">성별을 선택하세요</option>
					...
					<div class="row loginBtn" style="margin-bottom:15px;">
						<button class="btn btn-outline-primary" style="width:46%; margin:0 13px 0 10px;" onclick="login()">회원가입</button>
						<button class="btn btn-outline-primary" style="width:46%;" onclick="location.href='/views/user/signup'">홈으로</button>
					</div>
