			...
			<div class="shadow p-5 bg-white" style="border-radius:20px;">
				<div class="contact-form">
					<form action="#!">
						...
						<div class="loginBtn">
							<button class="btn btn-primary" style="width:70%;" onclick="login()">로그인</button>
							<button class="btn btn-primary" style="width:70%;" onclick="location.href='/views/user/signup'">회원가입</button>
						</div>
							<button onclick="location.href='/views/user/find-user'">비밀번호를 잊으셨나요?</button>
					</form>
				</div>
			</div>
		</div>
